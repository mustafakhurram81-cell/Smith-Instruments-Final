...
export default function FloatingWhatsApp() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center group"
      style={{
    ...
    >
      ...
      {isHovered && (
        <span className="ml-3 font-semibold whitespace-nowrap" style={{ fontFamily: 'Open Sans, sans-serif' }}>
          Chat with us
        </span>
      )}
    </button>
